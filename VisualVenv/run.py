...
class StartPage(tk.Frame):
    ...
    def buildbody(self):
        ...
        welcomelabel = tk.Label(upperframe, font=(FONT, 50), text="Welcome to VisualVenv")
        ...
        openButton = tk.Button(lowerframe, text="Open", command=lambda: self.openVenvPage(pathentry, lowerframe))
    ...
    def openVenvPage(self, pathentry, lowerframe):
        ...
        if path.exists(projectpath):
            ...
            alert = tk.Label(lowerframe, font=(FONT, 25), text="Path does not exist. Try again.")
...
class CreateVenvPage(tk.Frame):
    ...
    def buildbody(self):
        ...
        novenvlabel = tk.Label(upperframe, font=(FONT, 50), text="There is no venv at this path", bg=BG_COLOR)
        novenvlabel.pack()
        createvenvlabel = tk.Label(upperframe, font=(FONT, 25), text="Would you like to create one?", bg=BG_COLOR)
        createvenvlabel.pack()

        lowerframe = tk.Frame(self, bg='green', bd=5)
        lowerframe.place(relwidth=0.75, relheight = 0.5, relx=0.5, rely=0.4, anchor='n')

        createvenvbutton=tk.Button(lowerframe, font=(FONT, 20), text="Create Venv", command=lambda: self.createvenv())
